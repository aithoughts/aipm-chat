---
title: Deploy LoiChat with Netlify - Step-by-Step Guide
description: >-
  Learn how to deploy LoiChat on Netlify with detailed instructions on forking
...
# Deploy LoiChat with Netlify

If you want to deploy LoiChat on Netlify, you can follow these steps:

## Deploy LoiChat with Netlify

<Steps>
  ### Fork the LoiChat Repository

Click the Fork button to fork the LoiChat repository to your GitHub account.
...
Next, select the LoiChat project:

<Image
  alt={'Select the LoiChat github project'}
  height={228}
  inStep
...
<Image
  alt={'Configure LoiChat site name'}
  height={712}
  inStep
...
<Image
  alt={'Add LoiChat site environment variables'}
  height={537}
  inStep
...
Upon entering the deployment details, you will see the following interface, indicating that your LoiChat is currently being deployed. Simply wait for the deployment to complete.

<Image
  alt={'LoiChat deployment in progress'}
  height={325}
  inStep
...
If your Deploy Log in the interface looks like the following, it means your LoiChat has been successfully deployed.
...
At this point, you can click on "Open production deploy" to access your LoiChat site.

  <Image alt={'Access Your LoiChat Site'} height={527} inStep src={'https://github.com/lobehub/lobe-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
