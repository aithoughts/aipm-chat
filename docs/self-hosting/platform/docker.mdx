---
title: Deploy LoiChat with Docker
description: >-
  Learn how to deploy the LoiChat service using Docker, including installation
...
We provide a [Docker image][docker-release-link] for you to deploy the LoiChat service on your private device.
...
Use the following command to start the LoiChat service with one click:
