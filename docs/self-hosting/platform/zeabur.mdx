---
title: Deploy LoiChat on Zeabur
description: >-
...
# Deploy LoiChat with Zeabur

If you want to deploy LoiChat on Zeabur, you can follow the steps below:
...
# Deploy LoiChat with Zeabur as serverless function
...
Since Zeabur does NOT officially support FREE users deploy containerized service, you may wish to deploy LoiChat as a serverless function service. To deploy LoiChat as a serverless function service on Zeabur, you can follow the steps below:
...
### Link your fork of LoiChat to the just created Zeabur service.
