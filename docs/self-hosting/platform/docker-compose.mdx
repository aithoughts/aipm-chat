---
title: Deploy LoiChat with Docker Compose
description: >-
  Learn how to deploy the LoiChat service using Docker Compose. Follow
...
We provide a [Docker image][docker-release-link] for deploying the LoiChat service on your private device.
