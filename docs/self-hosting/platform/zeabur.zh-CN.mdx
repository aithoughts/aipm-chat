...
由于 Zeabur 并未官方支持免费用户部署容器化服务，您可能希望将 LoiChat 部署为无服务器函数服务。要在 Zeabur 上将 LoiChat 部署为无服务器函数服务，您可以按照以下步骤操作：
...
### 将您的 LoiChat 分支链接到刚创建的 Zeabur 服务。
