---
title: Deploy LoiChat with Database on RepoCloud
description: Learn how to deploy LoiChat on RepoCloud with ease, including: database, authentication and S3 storage service.
tags:
  - Deploy LobeChat
...
# Deploying LoiChat Database Edition with RepoCloud

If you want to deploy LoiChat Database Edition on RepoCloud, you can follow the steps below:
