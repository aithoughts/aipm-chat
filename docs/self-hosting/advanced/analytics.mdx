---
title: Integrating Data Analytics Services in LoiChat for User Usage Analysis
description: >-
  Learn how to integrate free/open-source data analytics services in LoiChat to
...
To better help analyze the usage of LoiChat users, we have integrated several free/open-source data analytics services in LoiChat for collecting user usage data, which you can enable as needed.
