...
description: >-
  Learn how to configure Auth0 Identity Verification Service for LoiChat for
...
Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to LoiChat.
...
<Callout>
  After successful deployment, users will be able to authenticate and use LoiChat using the users
  configured in Auth0.
</Callout>
...
<Callout type={'warning'}>
  ...
  LoiChat being abused by external users.
</Callout>
