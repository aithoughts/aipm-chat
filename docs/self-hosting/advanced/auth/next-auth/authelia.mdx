...
description: >-
  ...
  LoiChat. Detailed steps and necessary environment variable settings.
tags:
...
We assume you are already familiar with using Authelia. Let's say your LoiChat instance is deployed at https://lobe.example.com/.
...
Note! The secret configured in Authelia is ciphertext, i.e., a salted hash value. Its corresponding plaintext needs to be filled in LoiChat later.
