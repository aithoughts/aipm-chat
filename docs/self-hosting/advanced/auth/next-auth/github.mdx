...
| `NEXT_AUTH_SSO_PROVIDERS` | Required | Select the Single Sign-On provider for LoiChat. Use `github` for Github. |
...
<Callout type={'info'}>
  After successful deployment, users will be able to authenticate with Github and use LoiChat.
</Callout>
