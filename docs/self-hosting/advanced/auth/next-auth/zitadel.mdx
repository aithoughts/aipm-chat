...
description: >-
  Learn how to configure ZITADEL Authentication Service for LoiChat deployment,
...
- Replace `http(s)://your-domain` with the actual URL that LoiChat is deployed to.
...
<Callout>
  After successful deployment, users will be able to authenticate and use LoiChat using existing
