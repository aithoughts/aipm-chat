---
title: 在 LoiChat 中配置 Authelia 身份验证服务
description: 学习如何在 LoiChat 中配置 Authelia 身份验证服务，包括创建提供程序、配置环境变量和部署 LobeChat。详细步骤和必要环境变量设置。
tags:
  - Authelia
  - 身份验证
  - 单点登录
...
我们现在默认您已经了解了如何使用 Authelia。假设您的 LoiChat 实例部署在 `https://lobe.example.com/` 中。
