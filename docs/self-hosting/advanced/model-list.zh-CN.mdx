---
title: LoiChat 自定义模型服务商模型列表及扩展能力配置
description: 了解如何在 LoiChat 中自定义模型列表以及扩展能力配置的基本语法和规则。
tags:
  - LobeChat
  - 自定义模型列表
  - 扩展能力配置
...
LoiChat 支持在部署时自定义模型列表，详情请参考 [模型提供商](/zh/docs/self-hosting/environment-variables/model-provider) 。
