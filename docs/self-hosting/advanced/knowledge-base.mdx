...
LoiChat supports file upload and knowledge base management. This feature relies on the following core technical components. Understanding these components will help you successfully deploy and maintain the knowledge base system.
...
LoiChat currently uses OpenAI's `text-embedding-3-small` model by default. Ensure your API Key has access to this model.
...
By correctly configuring and integrating these core components, you can build a powerful and efficient knowledge base system for LoiChat. Each component plays a crucial role in the overall architecture, supporting advanced document management and intelligent retrieval functions.
