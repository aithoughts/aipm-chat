---
title: LoiChat Authentication Service Configuration
description: >-
...
LoiChat supports the configuration of external authentication services using Clerk or Next Auth for internal use within enterprises/organizations to centrally manage user authorization.
