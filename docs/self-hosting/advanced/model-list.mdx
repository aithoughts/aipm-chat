---
title: Customizing Provider Model List in LoiChat for Deployment
description: >-
  Learn how to customize the model list in LoiChat for deployment with the
...
LoiChat supports customizing the model list during deployment. This configuration is done in the environment for each [model provider](/docs/self-hosting/environment-variables/model-provider). 
