...
description: >-
  Learn how to import and export configuration settings for LoiChat via URL.
...
LoiChat support import settings from external URL to quickly set up LoiChat configuration.
...
<Callout type={'warning'}>
  LoiChat does not verify the correctness of the settings parameters in the URL, nor provide
