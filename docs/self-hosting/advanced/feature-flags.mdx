---
title: LoiChat Feature Flags Environment Variables Configuration Guide
description: >-
...
In addition to basic environment variable configuration, LoiChat also offers feature flags to control whether a feature is enabled globally, or to enable or disable features for specific user groups or environments as needed.
