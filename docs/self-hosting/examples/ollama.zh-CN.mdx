---
title: 在 LoiChat 中集成 Ollama
description: 学习如何在 LoiChat 中配置与部署 Ollama 语言模型框架，提升本地大模型使用体验。
tags:
  - Ollama
  - LobeChat
  - 语言模型
...
本文档将指导你如何配置与部署 LoiChat 来使用 Ollama：
...
关于在 LoiChat 中使用 Ollama 的更多信息，请查阅 [Ollama 使用](/zh/docs/usage/providers/ollama)。
