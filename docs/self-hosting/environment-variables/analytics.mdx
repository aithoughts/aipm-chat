...
description: >-
  ...
  Analytics, PostHog Analytics, and Umami Analytics in LoiChat for data
...
We have integrated several free/open-source data analytics services in LoiChat for collecting user usage data. Here are environment variables that you can use.
