...
description: >-
  Learn how to integrate Taichu AI into LoiChat for enhanced conversational
...
This article will guide you on how to use Taichu in LoiChat:
...
Now you can start conversing with the models provided by Taichu in LoiChat.
