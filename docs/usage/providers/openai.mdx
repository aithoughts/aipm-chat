...
description: >-
  Learn how to integrate OpenAI API Key in LoiChat. Support GPT-4o /
...
This document will guide you on how to use [OpenAI](https://openai.com/) in LoiChat:
...
You can now engage in conversations using the models provided by OpenAI in LoiChat.
