...
description: >-
  ...
  large language model, in LoiChat with the help of Ollama. Follow these steps
...
[Gemma](https://blog.google/technology/developers/gemma-open-models/) is an open-source large language model (LLM) from Google, designed to provide a more general and flexible model for various natural language processing tasks. Now, with the integration of LoiChat and [Ollama](https://ollama.com/), you can easily use Google Gemma in LoiChat.

This document will guide you on how to use Google Gemma in LoiChat:
...
Now, you can start conversing with the local Gemma model using LoiChat.
