...
description: >-
  Learn how to integrate Novita AI's language model APIs into LoiChat. Follow
...
This document will guide you on how to integrate Novita AI in LoiChat:
...
You can now engage in conversations using the models provided by Novita AI in LoiChat.
