...
description: >-
  Learn how to integrate and utilize Zhipu AI models in LoiChat for enhanced
...
This document will guide you on how to use Zhipu AI in LoiChat:
...
You can now engage in conversations using the models provided by Zhipu AI in LoiChat.
