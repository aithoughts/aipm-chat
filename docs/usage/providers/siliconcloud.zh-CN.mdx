---
title: 在 LoiChat 中使用 SiliconCloud API Key
description: 学习如何在 LoiChat 中配置和使用 SiliconCloud 提供的大语言模型，获取 API 密钥并开始对话。
tags:
  - LobeChat
  - SiliconCloud
  - API密钥
...
### 步骤二：在 LoiChat 中配置 SiliconCloud

- 访问 LoiChat 的 `应用设置` 界面
...
至此你已经可以在 LoiChat 中使用 SiliconCloud 提供的模型进行对话了。
