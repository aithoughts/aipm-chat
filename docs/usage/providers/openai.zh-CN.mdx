---
title: 在 LoiChat 中使用 OpenAI API Key
description: 学习如何在 LoiChat 中配置和使用 OpenAI API Key，支持 GPT-4o / GPT-4-turbo / GPT-4-vision
tags:
  - ChatGPT
  - GPT-4
  - GPT-4o
...
至此你已经可以在 LoiChat 中使用 OpenAI 提供的模型进行对话了。
