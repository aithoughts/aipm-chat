...
description: >-
  Learn how to integrate Mistral AI into LoiChat for enhanced conversational
...
The Mistral AI API is now available for everyone to use. This document will guide you on how to use [Mistral AI](https://mistral.ai/) in LoiChat:
...
You can now engage in conversations using the models provided by Mistral AI in LoiChat.
