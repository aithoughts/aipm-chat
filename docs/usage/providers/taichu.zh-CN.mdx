---
title: 在 LoiChat 中使用紫东太初 API Key
description: 学习如何在 LoiChat 中配置和使用紫东太初的API Key，以便开始对话和交互。
tags:
  - LobeChat
  - 太初
  - 紫东太初
...
至此你已经可以在 LoiChat 中使用紫东太初提供的模型进行对话了。
