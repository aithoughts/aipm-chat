...
This document will guide you on how to use DeepSeek in LoiChat:
...
- Access the `App Settings` interface in LoiChat.
...
You can now engage in conversations using the models provided by Deepseek in LoiChat.
