...
description: >-
  Learn how to integrate Anthropic Claude API in LoiChat to enhance your AI
...
The Anthropic Claude API is now available for everyone to use. This document will guide you on how to use [Anthropic Claude](https://www.anthropic.com/api) in LoiChat:
...
- Access the `Settings` interface in LoiChat.
...
You can now engage in conversations using the models provided by Anthropic Claude in LoiChat.
