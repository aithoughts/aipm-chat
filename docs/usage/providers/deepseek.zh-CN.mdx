---
title: 在 LoiChat 中使用 DeepSeek API Key
description: 学习如何在 LoiChat 中配置和使用 DeepSeek 语言模型，获取 API 密钥并开始对话。
tags:
  - LobeChat
  - DeepSeek
  - API密钥
...
# 在 LoiChat 中使用 DeepSeek

<Image
  alt={'在 LoiChat 中使用 DeepSeek'}
  cover
...
本文档将指导你如何在 LoiChat 中使用 DeepSeek:
...
至此你已经可以在 LoiChat 中使用 Deepseek 提供的模型进行对话了。
