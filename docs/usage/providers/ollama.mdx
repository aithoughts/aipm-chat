...
Ollama is a powerful framework for running large language models (LLMs) locally, supporting various language models including Llama 2, Mistral, and more. Now, LoiChat supports integration with Ollama, meaning you can easily enhance your application by using the language models provided by Ollama in LoiChat.

This document will guide you on how to use Ollama in LoiChat:

<Video
  alt="demonstration of using Ollama in LoiChat"
  height={580}
...
Now, you can start conversing with the local LLM in LoiChat.

<Image
  alt="Chat with llama3 in LoiChat"
  height="573"
...
<Image
  alt="LoiChat guide your to install Ollama model"
  height="460"
...
<Callout type={'info'}>
  ...
  LoiChat to meet integration needs with Ollama.
</Callout>
