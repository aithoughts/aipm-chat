...
description: >-
  Learn how to integrate and utilize Google Gemini AI in LoiChat to enhance
...
This document will guide you on how to use Google Gemini in LoiChat:
...
Congratulations! You can now use Google Gemini in LoiChat.
