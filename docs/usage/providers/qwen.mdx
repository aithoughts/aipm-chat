...
description: >-
  ...
  by Alibaba Cloud, in LoiChat for various tasks. Follow the steps to activate
...
This document will guide you on how to use Tongyi Qianwen in LoiChat:
...
- Visit the `Settings` interface in LoiChat.
...
You can now engage in conversations using the models provided by Tongyi Qianwen in LoiChat.
