...
description: >-
  ...
  LoiChat. Follow these steps to register, create an API key, recharge credit,
...
This document will guide you on how to use OpenRouter in LoiChat:
...
- Name your API key in the pop-up dialog, for example, "LoiChat Key"
...
You can now engage in conversations using the models provided by OpenRouter in LoiChat.
