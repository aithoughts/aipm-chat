...
description: >-
  Learn how to integrate and configure Azure OpenAI in LoiChat to enhance your
...
This document will guide you on how to use [Azure OpenAI](https://oai.azure.com/) in LoiChat:
...
Now you can engage in conversations using the models provided by Azure OpenAI in LoiChat.
