...
description: >-
  Learn how to integrate Baichuan AI into LoiChat for enhanced conversational
...
This article will guide you on how to use Baichuan in LoiChat:
...
You can now use the models provided by Baichuan for conversation in LoiChat.
