---
title: 在 LoiChat 中使用 01.AI 零一万物 API Key
description: >-
  学习如何在 LoiChat 中配置并使用 01.AI 零一万物提供的 AI 模型进行对话。获取 API 密钥、填入设置项、选择模型，开始与 AI
  助手交流。
tags:
  - LobeChat
  - 01.AI
...
至此你已经可以在 LoiChat 中使用零一万物提供的模型进行对话了。
