...
description: >-
  Learn how to use MiniMax in LoiChat to enhance AI conversations. Obtain
  MiniMax API key, configure MiniMax in LoiChat settings, and select a model
...
This document will guide you on how to use Minimax in LoiChat:
...
You can now use the models provided by MiniMax to have conversations in LoiChat.
