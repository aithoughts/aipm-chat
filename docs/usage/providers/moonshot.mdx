...
description: >-
  Learn how to integrate Moonshot AI into LoiChat for AI-powered conversations.
...
The Moonshot AI API is now available for everyone to use. This document will guide you on how to use [Moonshot AI](https://www.moonshot.cn/) in LoiChat:
...
You can now engage in conversations using the models provided by Moonshot AI in LoiChat.
