...
description: >-
  Learn how to integrate and use Perplexity AI in LoiChat to enhance your AI
...
The Perplexity AI API is now available for everyone to use. This document will guide you on how to use [Perplexity AI](https://www.perplexity.ai/) in LoiChat:
...
You can now engage in conversations using the models provided by Perplexity AI in LoiChat.
