---
title: Guide to Text-to-Speech Conversion - LoiChat TTS Feature
description: >-
...
LoiChat supports text-to-speech conversion, allowing users to input content through voice and have the AI output read aloud through speech.
...
Select the voice input feature in the input window, and LoiChat will convert your speech to text and input it into the text box. After completing the input, you can send it directly to the AI.
