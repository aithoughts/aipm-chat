...
description: >-
  Learn how to translate conversation content in LoiChat with just one click.
...
LoiChat supports users to translate conversation content into a specified language with just one click. After selecting the target language, LoiChat will use a pre-set AI model for translation and display the translated results in real-time in the chat window.
