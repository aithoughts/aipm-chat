...
description: >-
  Explore how LoiChat integrates visual recognition capabilities into large
...
The ecosystem of large language models that support visual recognition is becoming increasingly rich. Starting from `gpt-4-vision`, LoiChat now supports various large language models with visual recognition capabilities, enabling LoiChat to have multimodal interaction capabilities.
