---
title: Custom LoiChat Assistant Guide - Adding and Iterating Assistants
description: >-
  Learn how to add assistants to your favorites list in LoiChat through the
...
If you are a beginner in Prompt writing, you might want to browse the assistant market of LoiChat first. Here, you can find commonly used assistants submitted by others and easily add them to your list with just one click, which is very convenient.
