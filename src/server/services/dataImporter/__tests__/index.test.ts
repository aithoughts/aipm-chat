          ...
          sessions: [
            {
              ...
              meta: {
                avatar: '📝',
                description:
                  'LoiChat is an AI conversation application built with the Next.js framework. I will help you write the development documentation for LoiChat.',
                tags: [
                ...
                title: 'LoiChat Technical Documentation Expert',
              },
              type: 'agent',
